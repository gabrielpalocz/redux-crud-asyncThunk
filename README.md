# redux-crud-asyncThunk
This is a small project to make CRUD to a Express server with Postgres db and frontend React with Redux to deal with the state changes 
